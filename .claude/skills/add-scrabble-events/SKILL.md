...
4. Calculate specific dates using the date calculation script
5. Generate event objects from templates in event-rules.json
6. Append new TSV rows to events.tsv (never modify existing rows)
7. Display summary of added events
